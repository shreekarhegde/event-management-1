function pay() {
  ...
  for (let i = 0; i < eventIDs.length; i++) {
    ...
    http.send(
      `userID=${userID}&eventID=${eventIDs[i]}&amount=50&result='success'`
    );
  }
  document.location.href = `file:///C:/Users/R%20Soumya/projects/event-management-1/front-end/OnePage/index.html?userID=${userID}&payment=success`;
}
